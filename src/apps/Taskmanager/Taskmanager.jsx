...
import { Cpu, Gpu, MemoryStick, Microchip, Signal, Wifi } from "lucide-react";
...
export function Taskmanager(){
    ...
    useEffect(() => {
        ...
        setGpudata({
            ...
            shared: generateInitialData(7, 8),
            dedicated: generateInitialData(10, 6),
            })
    }, [])
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            setGpudata(prev => ({
                ...
                copy: updateData(prev.gpu3D, 2, 2),
                videoDecode: updateData(prev.gpu3D, 5, 4),
                videoProcessing: updateData(prev.gpu3D, 1, 1),
                shared: updateData(prev.gpu3D, 9, 6),
                dedicated: updateData(prev.gpu3D, 12, 4),
            }))
        }, 1000)
            ...
            <div className="flex">
                <div className="w-[15%] p-2">
                    ...
                    <div onClick={() => setOption("Wi-Fi")} className="flex items-center gap-2 cursor-pointer hover:bg-black/20">
                        <Wifi size={24} className="ml-2 text-blue-500"/>
                        <div className="p-2">
                            <p>Wi-Fi</p>
                    ...
                    {option === "GPU" && (
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div className="h-10 pt-2 border [background-image:repeating-linear-gradient(0deg,rgba(255,255,255,0.05)_0px,rgba(255,255,255,0.05)_1px,transparent_1px,transparent_12px),repeating-linear-gradient(90deg,rgba(255,255,255,0.05)_0px,rgba(255,255,255,0.05)_1px,transparent_1px,transparent_14px)]">
